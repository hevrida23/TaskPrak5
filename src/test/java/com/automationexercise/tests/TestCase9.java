...
public class TestCase9 extends TestBasic {
    ...
    public void searchProduct() {
        ...
        String actualPageTitle = new ProductsPage(getDriver())
                    .getTitleTextCenter()
                    .getText();
            Assert.assertEquals(actualPageTitle, "FEATURES ITEMS", "Verify user is navigated to ALL PRODUCTS page successfully");
        }
